...
public class LoginPresentation extends PageObject {
    ...
    @FindBy(xpath="//*[@id=\"canvas\"]") private WebElement general;
    @FindBy(xpath="//*[@id=\"email\"]") private WebElement email;
    @FindBy(xpath="/html/body/div[3]/div/div/span[2]/button[2]") private WebElement clickOnAcceptCookies;
    @FindBy(xpath="//ul[@class='tabsList']/li[1]") private WebElement clickOnEinloggenTab;
    @FindBy(xpath="//*[@id=\"loginForm\"]/div[2]/div/input") private WebElement emailInput;
    @FindBy(xpath="//*[@id=\"loginForm\"]/div[3]/div/input") private WebElement passwordInput;
    @FindBy(xpath="//button[@class='button button-primary button-lg']") private WebElement clickOnEinloggen;
    @FindBy(xpath="//button[@class='button button-primary button-md']") private WebElement clickOnSpielen;
    @FindBy(xpath="//*[@id=\"joinGame\"]/button") private WebElement clickOnLastGame;
    @FindBy(xpath="//*[@id=\"accountlist\"]/div/div[1]/div[2]/div[1]/div/div[11]/button") private WebElement clickOnFirstListSpielen;
    @FindBy(xpath = "//*[@id=\"menuTable\"]/li[1]/a/span")  private WebElement clickOnOverviewMenu;
    @FindBy(xpath = "//*[@id=\"joinGame\"]/button/span")  private WebElement getLastServerName;
    @FindBy(xpath = "//*[@id=\"joinGame\"]/a/button")  private WebElement clickOnPlay;
    ...
    public LoginPresentation(WebDriver driver){super(driver);}
