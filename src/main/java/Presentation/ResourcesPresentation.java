...
public class ResourcesPresentation extends PageObject {
    ...
    //Text
    @FindBy(xpath = "//*[@id=\"resources_metal\"]")
    private WebElement showMetal;
    @FindBy(xpath = "//*[@id=\"resources_crystal\"]")
    private WebElement showCrystal;
    @FindBy(xpath = "//*[@id=\"resources_deuterium\"]")
    private WebElement showDeuterium;
    @FindBy(xpath = "//*[@id=\"resources_energy\"]")
    private WebElement showEnergy;
    @FindBy(xpath = "/html/body/div[2]/div[2]/div[2]/div[2]/div[2]/div[2]/div[2]/form/table/tbody/tr[18]/td[2]/span")
    private WebElement showMetalCapacity;
    @FindBy(xpath = "//*[@id=\"inhalt\"]/div[2]/div[2]/form/table/tbody/tr[18]/td[2]/span")
    private WebElement showCrystalCapacity;
    @FindBy(xpath = "/html/body/div[2]/div[2]/div[2]/div[2]/div[2]/div[2]/div[2]/form/table/tbody/tr[18]/td[4]/span")
    private WebElement showDeuteriumCapacity;
    @FindBy(xpath = "/html/body/div[4]/div[3]/div[2]/div/div[1]/div/div[2]/div[2]/div/div[1]/ul/li[1]")
    private WebElement showOnlyMetalRequirement;
    @FindBy(xpath = "//*[@id=\"technologydetails\"]/div[2]/div/div[1]/ul/li[1]/text()")
    private WebElement showMetalRequirement;
    @FindBy(xpath = "//*[@id=\"technologydetails\"]/div[2]/div/div[1]/ul/li[2]/text()")
    private WebElement showCrystalRequirement;
    @FindBy(xpath = "//*[@id=\"technologydetails\"]/div[2]/div/div[1]/ul/li[3]/text()")
    private WebElement showDeuteriumRequirement;

    //Tab
    @FindBy(xpath = "//*[@id=\"menuTable\"]/li[2]/a/span")
    private WebElement clickVersorgungsTab;
    @FindBy(xpath = "//*[@id=\"menuTable\"]/li[2]/span/a")
    private WebElement clickVersorgungsEinstellungTab;

    //Click in Versorgung
    @FindBy(xpath = "/html/body/div[5]/div[3]/div[2]/div/div[2]/ul/li[1]/span")
    private WebElement clickMetalmine;
    @FindBy(xpath = "/html/body/div[5]/div[3]/div[2]/div/div[2]/ul/li[2]/span")
    private WebElement clickCrystalmine;
    @FindBy(xpath = "/html/body/div[5]/div[3]/div[2]/div/div[2]/ul/li[3]/span")
    private WebElement clickDeutmine;
    @FindBy(xpath = "/html/body/div[5]/div[3]/div[2]/div/div[2]/ul/li[4]/span")
    private WebElement clickSolarpowerplant;
    @FindBy(xpath = "/html/body/div[5]/div[3]/div[2]/div/div[2]/ul/li[8]/span")
    private WebElement clickMetalCapacity;
    @FindBy(xpath = "/html/body/div[5]/div[3]/div[2]/div/div[2]/ul/li[9]/span")
    private WebElement clickCrystalCapacity;
    @FindBy(xpath = "/html/body/div[5]/div[3]/div[2]/div/div[2]/ul/li[10]/span")
    private WebElement clickDeutCapacity;
    @FindBy(xpath = "/html/body/div[5]/div[3]/div[2]/div/div[1]/div/div[2]/div[2]/div/div[2]/button/span")
    private WebElement clickAusbauenButton;
